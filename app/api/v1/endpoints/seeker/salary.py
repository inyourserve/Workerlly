...
from app.api.v1.schemas.salary import SalaryCalculationRequest, SalaryCalculationResponse
...
async def calculate_salary(request: SalaryCalculationRequest):
    ...
    if not rate_data:
        raise HTTPException(status_code=404, detail="Rate not found for the given city and category")
